...
class ModelServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.GenerateStream = channel.unary_stream(
                '/inference.v1.ModelService/GenerateStream',
...
def add_ModelServiceServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'inference.v1.ModelService', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('inference.v1.ModelService', rpc_method_handlers)
